...
const Announcement = () => {
  ...
  return (
    <div style={{border: 'red solid'}} className="hidden overflow-hidden text-ellipsis whitespace-nowrap border-b border-blue-900 bg-blue-900 px-3 py-2 text-sm text-gray-200 md:block">
