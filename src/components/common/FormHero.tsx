...
const FormHero = ({
  ...
  return (
    <form id="contactForm" className={twMerge('', containerClass)} action="https://submit-form.com/d8auh69V9">
      {title && <p className={`${description ? 'mb-2' : 'mb-2'} text-2xl font-bold`}>{title}</p>}
        ...
        <div className="mx-0 mb-1 sm:mb-2">
          {inputs &&
            inputs.map(({ type, label, name, autocomplete, placeholder }, index) => (
              <div key={`item-input-${index}`} className="mx-0 mb-1 sm:mb-2">
